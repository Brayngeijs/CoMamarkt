...
namespace CoMamarkt.Migrations
{
    ...
    [Migration("20200121103424_Checkut")]
    partial class Checkut
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CoMaMarkt.Models.Nieuws", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CoMamarkt.Models.BestellingProduct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("BestellingProducts");
                });

            modelBuilder.Entity("CoMamarkt.Models.User", b =>
                {
            ...
            modelBuilder.Entity("CoMaMarkt.Models.Bestelling", b =>
                {
                    b.HasOne("CoMamarkt.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("CoMamarkt.Models.BestellingProduct", b =>
                {
                    ...
                    b.HasOne("CoMaMarkt.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("CoMamarkt.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
